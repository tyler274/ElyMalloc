//! ElyMalloc core (`no_std`, no `alloc` crate).
//!
...
//!
//! The C ABI lives in `elymalloc-c`. This crate is also a
//! [`core::alloc::GlobalAlloc`] ([`ElyMalloc`]) for `wasm32` and Rust programs.
//!
...
//! ABI probe `tests/chaos.c` is part of `elymalloc-harness c-abi`.
//!
//! # Safety
//!
