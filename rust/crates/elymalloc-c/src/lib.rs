...
//!
//! Thin `extern "C"` wrappers around [`elymalloc_core`]. Exports both `mi_*`
...
fn elymalloc_core_abort() -> ! {
    elymalloc_core::abort()
}
...
// Each function is a C ABI trampoline into `elymalloc_core`.
// ---------------------------------------------------------------------------
...
pub unsafe extern "C" fn mi_process_done() {
    if elymalloc_core::mi_options::is_enabled(1) || elymalloc_core::mi_options::is_enabled(2) {
...
#[no_mangle]
pub unsafe extern "C" fn mi_heap_new() -> *mut elymalloc_core::Heap {
    elymalloc_core::heap_new()
}

#[no_mangle]
pub unsafe extern "C" fn mi_heap_delete(heap: *mut elymalloc_core::Heap) {
    elymalloc_core::heap_delete(heap);
}

#[no_mangle]
pub unsafe extern "C" fn mi_heap_destroy(heap: *mut elymalloc_core::Heap) {
    elymalloc_core::heap_destroy(heap);
}

#[no_mangle]
pub unsafe extern "C" fn mi_heap_collect(heap: *mut elymalloc_core::Heap, force: bool) {
    elymalloc_core::heap_collect(heap, force);
}
...
pub unsafe extern "C" fn mi_heap_malloc(
    ...
    pvoid(elymalloc_core::heap_malloc(heap, size))
}
...
pub unsafe extern "C" fn mi_heap_zalloc(
    ...
    let p = elymalloc_core::heap_malloc(heap, size);
    if !p.is_null() {
        core::ptr::write_bytes(p, 0, size);
    }
    pvoid(p)
...
pub unsafe extern "C" fn mi_heap_malloc_aligned(
    ...
    pvoid(elymalloc_core::heap_malloc_aligned(heap, size, alignment))
}
...
pub unsafe extern "C" fn mi_heap_malloc_aligned_at(
    ...
    pvoid(elymalloc_core::heap_malloc_aligned_at(
...
pub unsafe extern "C" fn mi_heap_realloc(
    ...
    let q = elymalloc_core::heap_malloc(heap, newsize);
    if q.is_null() {
        return core::ptr::null_mut();
    }
    core::ptr::copy_nonoverlapping(p as *const u8, q, old.min(newsize));
...
#[no_mangle]
pub unsafe extern "C" fn mi_heap_main() -> *mut elymalloc_core::Heap {
    elymalloc_core::heap_main()
}

#[no_mangle]
pub unsafe extern "C" fn mi_heap_of(p: *const c_void) -> *mut elymalloc_core::Heap {
    elymalloc_core::heap_of(p as *const u8)
}

#[no_mangle]
pub unsafe extern "C" fn mi_heap_contains(
    heap: *const elymalloc_core::Heap,
    p: *const c_void,
) -> bool {
    elymalloc_core::heap_contains(heap, p as *const u8)
}

#[no_mangle]
pub unsafe extern "C" fn mi_any_heap_contains(p: *const c_void) -> bool {
    elymalloc_core::any_heap_contains(p as *const u8)
}
...
#[no_mangle]
pub unsafe extern "C" fn mi_heap_set_numa_affinity(heap: *mut elymalloc_core::Heap, numa_node: i32) {
    elymalloc_core::heap_set_numa_affinity(heap, numa_node);
}

#[no_mangle]
pub unsafe extern "C" fn mi_heap_theap(
    heap: *mut elymalloc_core::Heap,
) -> *mut elymalloc_core::Theap {
    elymalloc_core::heap_theap(heap)
}

#[no_mangle]
pub unsafe extern "C" fn mi_theap_get_default() -> *mut elymalloc_core::Theap {
    elymalloc_core::theap_get_default()
}

#[no_mangle]
pub unsafe extern "C" fn mi_theap_set_default(
    theap: *mut elymalloc_core::Theap,
) -> *mut elymalloc_core::Theap {
    elymalloc_core::theap_set_default(theap)
}

#[no_mangle]
pub unsafe extern "C" fn mi_theap_collect(theap: *mut elymalloc_core::Theap, force: bool) {
    elymalloc_core::theap_collect(theap, force);
}
...
pub unsafe extern "C" fn mi_theap_malloc(
    ...
    pvoid(elymalloc_core::theap_malloc(theap, size))
}
...
pub unsafe extern "C" fn mi_theap_zalloc(
    ...
    let p = elymalloc_core::theap_malloc(theap, size);
    if !p.is_null() {
        core::ptr::write_bytes(p, 0, size);
    }
    pvoid(p)
...
pub unsafe extern "C" fn mi_theap_wmalloc_small(
    ...
    pvoid(elymalloc_core::theap_wmalloc_small(theap, wsize))
}
...
pub unsafe extern "C" fn mi_theap_wzalloc_small(
    ...
    pvoid(elymalloc_core::theap_wzalloc_small(theap, wsize))
}
...
pub unsafe extern "C" fn mi_theap_malloc_aligned(
    ...
    pvoid(elymalloc_core::theap_malloc_aligned(theap, size, alignment))
}
...
pub unsafe extern "C" fn mi_theap_zalloc_aligned(
    ...
    let p = elymalloc_core::theap_malloc_aligned(theap, size, alignment);
    if !p.is_null() {
        core::ptr::write_bytes(p, 0, size);
    }
    pvoid(p)
...
pub unsafe extern "C" fn mi_theap_realloc(
    ...
    let q = elymalloc_core::theap_malloc(theap, newsize);
    if q.is_null() {
        return core::ptr::null_mut();
    }
    core::ptr::copy_nonoverlapping(p as *const u8, q, old.min(newsize));
...
pub unsafe extern "C" fn mi_theap_guarded_set_sample_rate(
    ...
    elymalloc_core::theap_guarded_set_sample_rate(theap, sample_rate, seed);
}
...
pub unsafe extern "C" fn mi_theap_guarded_set_size_bound(
    ...
    elymalloc_core::theap_guarded_set_size_bound(theap, min, max);
}
...
pub unsafe extern "C" fn mi_reserve_os_memory_ex(
    ...
    let mut a: *mut elymalloc_core::Arena = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn mi_heap_new_in_arena(arena_id: *mut c_void) -> *mut elymalloc_core::Heap {
    elymalloc_core::heap_new_in_arena(arena_id as *mut elymalloc_core::Arena)
}

#[no_mangle]
pub unsafe extern "C" fn mi_arena_area(arena_id: *mut c_void, size: *mut usize) -> *mut c_void {
    elymalloc_core::mi_arena::area(arena_id as *const elymalloc_core::Arena, size) as *mut c_void
}

#[no_mangle]
pub unsafe extern "C" fn mi_arena_contains(arena_id: *mut c_void, p: *const c_void) -> bool {
    elymalloc_core::mi_arena::contains(arena_id as *const elymalloc_core::Arena, p as *const u8)
}

#[no_mangle]
pub unsafe extern "C" fn mi_arena_min_alignment() -> usize {
    elymalloc_core::mi_arena::ARENA_MIN_ALIGN
}

#[no_mangle]
pub unsafe extern "C" fn mi_arena_max_object_size() -> usize {
    elymalloc_core::LARGE_MAX_OBJ_SIZE
}
...
pub unsafe extern "C" fn mi_heap_visit_blocks(
    heap: *mut elymalloc_core::Heap,
    visit_blocks: bool,
    visitor: Option<elymalloc_core::BlockVisitFun>,
    arg: *mut c_void,
) -> bool {
    elymalloc_core::heap_visit_blocks(heap, visit_blocks, visitor, arg)
}
...
pub unsafe extern "C" fn mi_heap_visit_abandoned_blocks(
    ...
    elymalloc_core::heap_visit_abandoned_blocks(heap, visit_blocks, visitor, arg)
}

#[no_mangle]
pub unsafe extern "C" fn mi_theap_visit_blocks(
    theap: *const elymalloc_core::Theap,
    visit_blocks: bool,
    visitor: Option<elymalloc_core::BlockVisitFun>,
    arg: *mut c_void,
) -> bool {
    elymalloc_core::theap_visit_blocks(
        theap as *mut elymalloc_core::Theap,
        visit_blocks,
        visitor,
        arg,
    )
...
#[no_mangle]
pub unsafe extern "C" fn mi_subproc_main() -> elymalloc_core::SubprocId {
    elymalloc_core::mi_subproc::main()
}

#[no_mangle]
pub unsafe extern "C" fn mi_subproc_current() -> elymalloc_core::SubprocId {
    elymalloc_core::mi_subproc::current()
}

#[no_mangle]
pub unsafe extern "C" fn mi_subproc_new() -> elymalloc_core::SubprocId {
    elymalloc_core::mi_subproc::new()
}

#[no_mangle]
pub unsafe extern "C" fn mi_subproc_destroy(subproc: elymalloc_core::SubprocId) {
    elymalloc_core::mi_subproc::destroy(subproc);
}

#[no_mangle]
pub unsafe extern "C" fn mi_subproc_add_current_thread(subproc: elymalloc_core::SubprocId) {
    elymalloc_core::mi_subproc::add_current_thread(subproc);
}

#[no_mangle]
pub unsafe extern "C" fn mi_subproc_visit_heaps(
    subproc: elymalloc_core::SubprocId,
    visitor: Option<elymalloc_core::mi_subproc::HeapVisitFun>,
    arg: *mut c_void,
) -> bool {
    elymalloc_core::mi_subproc::visit_heaps(subproc, visitor, arg)
}
...
pub unsafe extern "C" fn mi_register_deferred_free(f: *mut c_void, arg: *mut c_void) {
    elymalloc_core::hooks::register_deferred_free(f, arg);
}
...
pub unsafe extern "C" fn mi_register_error(f: *mut c_void, arg: *mut c_void) {
    elymalloc_core::hooks::register_error(f, arg);
}

#[no_mangle]
pub unsafe extern "C" fn mi_thread_set_in_threadpool() {
    elymalloc_core::theap_set_in_threadpool(elymalloc_core::theap_get_default());
}

#[no_mangle]
pub unsafe extern "C" fn mi_collect_reduce(target_thread_owned: usize) {
    elymalloc_core::collect_reduce(target_thread_owned);
}
...
pub unsafe extern "C" fn mi_options_print_out(out: *mut c_void, arg: *mut c_void) {
    ...
    libc::snprintf(
        ...
        elymalloc_core::MI_MALLOC_VERSION / 10000,
        (elymalloc_core::MI_MALLOC_VERSION % 10000) / 100,
        elymalloc_core::MI_MALLOC_VERSION % 100,
    );
    emit_cstr(out, arg, buf.as_ptr());
    for i in 0..elymalloc_core::mi_options::NAMES.len() {
        let Some(name) = elymalloc_core::mi_options::name(i as i32) else {
            continue;
        };
        ...
        libc::snprintf(
            ...
            b"option '%s': %ld\n\0".as_ptr() as *const libc::c_char,
            namebuf.as_ptr(),
            elymalloc_core::mi_options::get(i as i32) as libc::c_long,
        );
        emit_cstr(out, arg, buf.as_ptr());
    }
}
...
pub unsafe extern "C" fn mi_heap_strdup(
    ...
    let n = libc::strlen(s);
    let d = elymalloc_core::heap_malloc(heap, n + 1) as *mut libc::c_char;
    if !d.is_null() {
...
pub unsafe extern "C" fn mi_heap_strndup(
    ...
    let d = elymalloc_core::heap_malloc(heap, len + 1) as *mut libc::c_char;
    if !d.is_null() {
...
pub unsafe extern "C" fn mi_heap_zalloc_aligned(
    ...
    let p = elymalloc_core::heap_malloc_aligned(heap, size, alignment);
    if !p.is_null() {
        core::ptr::write_bytes(p, 0, size);
    }
    pvoid(p)
...
pub unsafe extern "C" fn mi_heap_zalloc_aligned_at(
    ...
    let p = elymalloc_core::heap_malloc_aligned_at(heap, size, alignment, offset);
    if !p.is_null() {
        core::ptr::write_bytes(p, 0, size);
    }
    pvoid(p)
...
pub unsafe extern "C" fn mi_heap_realloc_aligned_at(
    ...
    let q = elymalloc_core::heap_malloc_aligned_at(heap, newsize, alignment, offset);
    if q.is_null() {
        return core::ptr::null_mut();
    }
    core::ptr::copy_nonoverlapping(p as *const u8, q, old.min(newsize));
...
unsafe fn print_stats(stats: &elymalloc_core::Stats, out: *mut c_void, arg: *mut c_void) {
    let mut buf = [0 as libc::c_char; 256];
    libc::snprintf(
        buf.as_mut_ptr(),
        buf.len(),
...
pub unsafe extern "C" fn mi_stats_reset() {
    elymalloc_core::mi_stats::reset();
}

#[no_mangle]
pub unsafe extern "C" fn mi_stats_get(stats: *mut elymalloc_core::Stats) -> bool {
    if stats.is_null() {
        return false;
    }
    elymalloc_core::mi_stats::fill(stats);
    true
}
...
unsafe extern "C" fn arena_print_visitor(a: *mut elymalloc_core::Arena, arg: *mut c_void) -> bool {
...
pub unsafe extern "C" fn mi_arenas_print() {
    ...
    elymalloc_core::mi_arena::visit_all(
        arena_print_visitor,
...
pub unsafe extern "C" fn mi_option_set(option: i32, value: libc::c_long) {
    elymalloc_core::mi_options::set(option, value as i64);
}
...
pub unsafe extern "C" fn mi_option_enable(option: i32) {
    elymalloc_core::mi_options::enable(option);
}

#[no_mangle]
pub unsafe extern "C" fn mi_option_disable(option: i32) {
    elymalloc_core::mi_options::disable(option);
}
...
pub unsafe extern "C" fn mi_option_is_enabled(option: i32) -> bool {
    elymalloc_core::mi_options::is_enabled(option)
}

#[no_mangle]
pub unsafe extern "C" fn mi_option_get(option: i32) -> libc::c_long {
    elymalloc_core::mi_options::get(option) as libc::c_long
}
...
pub unsafe extern "C" fn mi_option_get_clamp(
    ...
    elymalloc_core::mi_options::clamp(option, min as i64, max as i64) as libc::c_long
}

#[no_mangle]
pub unsafe extern "C" fn mi_option_get_size(option: i32) -> usize {
    elymalloc_core::mi_options::get_size(option)
}

#[no_mangle]
pub unsafe extern "C" fn mi_arena_min_size() -> usize {
    elymalloc_core::mi_arena::ARENA_MIN_SIZE
}
...
pub unsafe extern "C" fn mi_unsafe_heap_page_is_under_utilized(
    ...
    elymalloc_core::page_is_under_utilized(heap, p as *const u8, perc_threshold)
}

#[no_mangle]
pub unsafe extern "C" fn mi_stats_merge() {
    elymalloc_core::stats_merge();
}
...
#[no_mangle]
pub unsafe extern "C" fn mi_heap_stats_merge_to_subproc(heap: *mut elymalloc_core::Heap) {
    elymalloc_core::heap_stats_merge_to_subproc(heap);
}

#[no_mangle]
pub unsafe extern "C" fn mi_stats_get_bin_size(bin: usize) -> usize {
    elymalloc_core::mi_stats::get_bin_size(bin)
}

#[no_mangle]
pub unsafe extern "C" fn mi_heap_stats_get(
    heap: *mut elymalloc_core::Heap,
    stats: *mut elymalloc_core::Stats,
) -> bool {
    elymalloc_core::heap_stats_get(heap, stats)
}
...
pub unsafe extern "C" fn mi_theap_stats_get(
    ...
    elymalloc_core::theap_stats_get(theap, stats)
}

#[no_mangle]
pub unsafe extern "C" fn mi_theap_stats_merge_to_heap(theap: *mut elymalloc_core::Theap) {
    elymalloc_core::theap_stats_merge_to_heap(theap);
}
...
pub unsafe extern "C" fn mi_subproc_stats_get(
    ...
    elymalloc_core::mi_subproc::stats_get(subproc, stats, false)
}
...
pub unsafe extern "C" fn mi_subproc_stats_get_exclusive(
    ...
    elymalloc_core::mi_subproc::stats_get(subproc, stats, true)
}
...
unsafe fn stats_as_json(
    ...
    let n = libc::snprintf(
        ...
        b"{\"stat_version\":%zu,\"mimalloc_version\":%d,\"pages\":{\"current\":%lld,\"peak\":%lld,\"total\":%lld}}\n\0"
            .as_ptr() as *const libc::c_char,
        (*stats).version,
        elymalloc_core::MI_MALLOC_VERSION,
        (*stats).pages.current as libc::c_longlong,
        (*stats).pages.peak as libc::c_longlong,
        (*stats).pages.total as libc::c_longlong,
    );
...
pub unsafe extern "C" fn mi_subproc_stats_print_out(
    _subproc: elymalloc_core::SubprocId,
    out: *mut c_void,
    arg: *mut c_void,
) {
    mi_stats_print_out(out, arg);
...
pub unsafe extern "C" fn mi_heap_profile(
    heap: *mut elymalloc_core::Heap,
    profiler: *mut elymalloc_core::Profiler,
) -> bool {
    elymalloc_core::heap_profile(heap, profiler)
}

#[no_mangle]
pub unsafe extern "C" fn mi_heap_profile_disable(heap: *mut elymalloc_core::Heap) {
    elymalloc_core::heap_profile_disable(heap);
}
...
pub unsafe extern "C" fn mi_subproc_profile(
    ...
    elymalloc_core::subproc_profile(subproc, profiler)
}

#[no_mangle]
pub unsafe extern "C" fn mi_profile(profiler: *mut elymalloc_core::Profiler) -> bool {
    elymalloc_core::attach_profile(profiler)
}

#[no_mangle]
pub unsafe extern "C" fn mi_profiler_start(profiler: *mut elymalloc_core::Profiler) -> bool {
    elymalloc_core::profiler_start(profiler)
}

#[no_mangle]
pub unsafe extern "C" fn mi_profiler_stop(profiler: *mut elymalloc_core::Profiler) -> bool {
    elymalloc_core::profiler_stop(profiler)
}
